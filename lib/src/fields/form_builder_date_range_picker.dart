...
//
//   @override
//   FormBuilderDateRangePickerState createState() => FormBuilderDateRangePickerState();
//
...
// }
//
// class FormBuilderDateRangePickerState extends FormBuilderFieldState<FormBuilderDateRangePicker, List<DateTime>> {
...
//       final initialFirstDate = value?.isEmpty ?? true ? (widget.initialFirstDate ?? DateTime.now()) : value[0];
//       final initialLastDate =
//           value?.isEmpty ?? true ? (widget.initialLastDate ?? initialFirstDate) : (value.length < 2 ? initialFirstDate : value[1]);
...
//   }
//
//   String format(DateTime date) => FormBuilderDateRangePicker.tryFormat(date, widget.format ?? intl.DateFormat.yMd());
//
